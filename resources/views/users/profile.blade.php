...
@section('content')
    ...
    <main>
        {{-- backend user dump for debugging --}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div
                                                            ...
                                                            <div class="profile__main-thumb">
                                                                <img
                                                                    src="{{ isset($user) && $user->avatar ? asset($user->avatar) : asset('assets/img/users/user-12.png') }}"
                                                                    alt="">
                                                                <div class="profile__main-thumb-edit">
                                                                    {{-- <form action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <input name="avatar" id="profile-thumb-input" class="profile-img-popup" type="file" onchange="this.form.submit()">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="profile__main-logout text-sm-end">
                                                            <form action="{{ route('logout') }}" method="post">
                                                                @csrf
                                                                <button type="submit" class="tp-logout-btn">Logout
                                                                </button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row gx-3">
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="profile__main-info-item">
                                                          ...
                                                          <span>
                                                                 <span class="profile-icon-count profile-order">{{$user->orders()->count()}}</span>
                                                    ...
                                                    {{--<div class="col-md-4 col-sm-6">
                                                        <div class="profile__main-info-item">
                                                          ...
                                                          <span>
                                                            ...
                                                            <h4 class="profile__main-info-title">{{ __('header.wishlist') }}</h4>
                                                        </div>
                                                    </div>--}}
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="profile__main-info-item">
                                                            <div class="profile__main-info-icon">
                                                          <span>
                                                                 <span class="profile-icon-count profile-cart">3</span>
                                                                 <svg viewBox="0 0 24 24"
                                                                      xmlns="http://www.w3.org/2000/svg"><path
                                                                         d="M7 18c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12L8.1 13h7.45c.75 0 1.41-.41 1.75-1.03L21.7 4H5.21l-.94-2H1zm16 16c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg>
                                                          </span>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xxl-6 col-md-6">
                                                            <div class="profile__input-box">
                                                                <div class="profile__input">
                                                                    <select name="type">
                                                                        <option
                                                                            value="details" {{ (old('type', $user->type ?? '') == 'details') ? 'selected' : '' }}>
                                                                            Retail
                                                                        </option>
                                                                        <option
                                                                            value="gros" {{ (old('type', $user->type ?? '') == 'gros') ? 'selected' : '' }}>
                                                                            Wholesale
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="profile__input">
                                                                    <select id="wilaya_id" name="wilaya_id">
                                                                        @foreach(\Kossa\AlgerianCities\Wilaya::all() as $wilaya)
                                                                            <option
                                                                                value="{{$wilaya->id}}"
                                                                                {{ (old('wilaya_id', $user->wilaya_id ?? '') == $wilaya->id) ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col-xxl-12">
                                                            <div class="profile__btn">
                                                                <button type="submit" class="tp-btn">Update Profile
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <form action="{{ route('profile.password.update') }}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="tp-profile-input-box">
                                                            <div class="tp-profile-input">
                                                                <input name="password_confirmation" id="con_new_pass"
                                                                       type="password">
                                                            </div>
                                                            <div class="tp-profile-input-title">
                                        ...
                                        <div class="profile__ticket table-responsive">
                                            <table class="table">
                                                ...
                                                @if($user->orders()->count() == 0)
                                                    <tr><th colspan="4">No Orders !</th></tr>
                                                @endif
                                                @foreach($user->orders()->latest()->get() as $order)
                                                    <tr>
                                                        <th scope="row">{{$order->id}}</th>
                                                        <td data-info="title">{{$order->total_price}}</td>
                                                        <td data-info="title">{{$order->shipping_price}}</td>
                                                        <td data-info="status pending">{{$order->order_status}}</td>
                                                        <td><a href="#" class="tp-logout-btn">View</a></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Get user's wilaya/commune IDs from Blade
            const userWilayaId = "{{ old('wilaya_id', $user->wilaya_id ?? '') }}";
            const userCommuneId = "{{ old('commune_id', $user->commune_id ?? '') }}";

            // Set wilaya select if needed (in case JS/niceSelect replaces select UI)
            ...
            function loadCommunes(wilayaId, selectedCommuneId = null) {
                fetch(`/api/wilayas/${wilayaId}/communes`)
                    ...
                    .then(data => {
                        ...
                        // Set selected and update plugin
            ...
            // Initial population: load communes and select current user's commune
            if (userWilayaId) {
                loadCommunes(userWilayaId, userCommuneId);
            }

            // On wilaya change, reset commune select
