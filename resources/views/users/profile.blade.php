                              ...
                              <div class="tab-content" id="profile-tabContent">
                                        ...
                                        <div class="profile__main-top pb-80">
                                             ...
                                             <div class="col-md-6">
                                                  ...
                                                  <div class="profile__main-thumb">
                                                       <img src="{{ isset($user) && $user->avatar ? asset($user->avatar) : asset('assets/img/users/user-12.png') }}" alt="">
                                             ...
                                             <div class="col-md-6">
                                                              ...
                                                              <form action="{{ route('logout') }}" method="post">
                                                                   @csrf
                                                                   <button type="submit" class="tp-logout-btn">Logout</button>
                                                              </form>
                                                              </div>
                                             </div>
                                             </div>
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <input name="name" type="text" placeholder="Enter your username" value="{{ old('name', $user->name ?? '') }}">
                                                            <span>
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <input name="email" type="email" placeholder="Enter your email" value="{{ old('email', $user->email ?? '') }}">
                                                            <span>
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <input name="facebook" type="text" placeholder="Enter username" value="{{ old('facebook') }}">
                                                            <span>
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <input name="twitter" type="text" placeholder="Enter username" value="{{ old('twitter') }}">
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <input name="phone" type="text" placeholder="Enter your number" value="{{ old('phone', $user->phone ?? '') }}">
                                                            <span>
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <select name="type">
                                                            <option value="details" {{ (old('type', $user->type ?? '') == 'details') ? 'selected' : '' }}>Retail</option>
                                                            <option value="gros" {{ (old('type', $user->type ?? '') == 'gros') ? 'selected' : '' }}>Wholesale</option>
                                                            </select>
                                                       </div>
                                                  </div>
                                                  </div>
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <input name="address" type="text" placeholder="Enter your address" value="{{ old('address', $user->address ?? '') }}">
                                                            <span>
                                                  ...
                                                  <div class="profile__input-box">
                                                       <div class="profile__input">
                                                            <textarea name="bio" placeholder="Enter your bio">{{ old('bio') }}</textarea>
                                                       </div>
                                                  </div>
                                                  </div>
                                                  <div class="col-xxl-12">
                                   ...
                                   <div class="profile__password">
                                             ...
                                             <div class="col-xxl-6 col-md-6">
                                                  <div class="tp-profile-input-box">
                                                  <div class="tp-profile-input">
                                                       <input name="password_confirmation" id="con_new_pass" type="password">
                                                  </div>
                                                  <div class="tp-profile-input-title">
