...
<section class="breadcrumb__area breadcrumb__style-2 include-bg pt-50 pb-20" data-bg-color="{{ $breadcrumbData['bgColor'] ?? '#FFF' }}">
    <div class="container">
        <div class="row">
                            ...
                            {{-- <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                               ...
                               <path
                                   ...
                                   fill="#55585B" stroke="#55585B" stroke-width="0.5"/>
                                        ...
                                        {{-- {{ $breadcrumbData['title'] ?? 'Product Details' }} --}}
                        </span>
