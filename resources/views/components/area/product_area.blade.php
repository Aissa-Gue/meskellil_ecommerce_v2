  <!-- product area start -->
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="/products/{{ $product->id }}">
                                             {{-- <img src="{{ asset($product->image1 ?? 'assets/img/product/product-1.jpg') }}" alt="{{ $product->name }}"> --}}
                                          ...
                                          <div class="tp-product-action">
                                             <div class="tp-product-action-item d-flex flex-column">
                                                <button type="button" class="tp-product-action-btn tp-product-add-cart-btn" data-product-id="{{ $product->id }}">
                                                   <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                      ...
                                                      <path fill-rule="evenodd" clip-rule="evenodd" d="M16.435 17.702C16.736 17.702 16.98 17.945 16.98 18.246C16.98 18.547 16.736 18.791 16.435 18.791C16.133 18.791 15.89 18.547 15.89 18.246C16.89 17.945 16.133 17.702 16.435 17.702Z" fill="currentColor"/>
                                                ...
                                                <button type="button" class="tp-product-action-btn tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal" data-product-id="{{ $product->id }}">
                                                ...
                                                <button type="button" class="tp-product-action-btn tp-product-add-to-wishlist-btn" data-product-id="{{ $product->id }}">
                                          ...
                                          <div class="tp-product-rating d-flex align-items-center">
                                             ...
                                             <div class="tp-product-rating-text">
                                                <span>(6 Review)</span>
                                                                                     ...
                                                                                     {{-- protected $fillable = [
        'name', 'size', 'brand_id', 'category_id', 'use_case', 'details',
        ...
        'is_active'
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price">{{ $product->price1 }}</span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
