                    ...
                    <h3 class="tp-section-title">
                        ...
                        <svg width="114" height="35" viewBox="0 0 114 35" fill="none"
                            ...
                            <path d="M112 23.275C1.84952 -10.6834 -7.36586 1.48086 7.50443 32.9053"
                                  stroke="primaryColor" stroke-width="4" stroke-miterlimit="3.8637"
                    ...
                    <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="featured-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="featured-tab-pane" aria-selected="false">
                                {{ __('header.featured') }}
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="topsell-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="topsell-tab-pane" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="discounted-tab" data-bs-toggle="tab"
                                    data-bs-target="#discounted-tab-pane" type="button" role="tab"
                                    aria-controls="discounted-tab-pane" aria-selected="false">
            ...
            <div class="col-xl-12">
                <div class="tp-product-tab-content">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="discounted-tab-pane" role="tabpanel"
                             aria-labelledby="discount-tab" tabindex="0">
                            <div class="row">
...
</section><!-- End of tp-product-area -->
