                                                        ...
                                                        <div class="home-menu-item ">
                                                            <a href="index.html">
                                                                <div class="home-menu-thumb p-relative fix">
                                                                    <img
                                                                        src="{{asset('assets/img/menu/menu-home-1.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="home-menu-item ">
                                                            <a href="index-2.html">
                                                                <div class="home-menu-thumb p-relative fix">
                                                                    <img
                                                                        src="{{asset('assets/img/menu/menu-home-2.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                                <div class="home-menu-content">
                                                    ...
                                                    <div class="col">
                                                        <div class="home-menu-item ">
                                                            <a href="index-3.html">
                                                                <div class="home-menu-thumb p-relative fix">
                                                                    <img
                                                                        src="{{asset('assets/img/menu/menu-home-3.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                                <div class="home-menu-content">
                                                    ...
                                                    <div class="col">
                                                        <div class="home-menu-item ">
                                                            <a href="index-4.html">
                                                                <div class="home-menu-thumb p-relative fix">
                                                                    <img
                                                                        src="{{asset('assets/img/menu/menu-home-4.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                                <div class="home-menu-content">
                                                    ...
                                                    <div class="col">
                                                        <div class="home-menu-item ">
                                                            <a href="index-5.html">
                                                                <div class="home-menu-thumb p-relative fix">
                                                                    <img
                                                                        src="{{asset('assets/img/menu/menu-home-5.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                                <div class="home-menu-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="shop-mega-menu-img">
                                                            <img
                                                                src="{{ asset('assets/img/menu/product/menu-product-img-1.jpg') }}"
                                                                alt="">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="shop-mega-menu-img">
                                                            <img
                                                                src="{{ asset('assets/img/menu/product/menu-product-img-2.jpg') }}"
                                                                alt="">
                                                            <div class="shop-mega-menu-btn">
                                                                <a href="shop-category.html"
                                            ...
                                            <ul class="mega-menu tp-submenu">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html"><img
                                                                    src="{{ asset('assets/img/header/menu/menu-1.jpg') }}"
                                                                    alt=""></a>
                                                        </li>
                                                        <li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html"><img
                                                                    src="{{ asset('assets/img/header/menu/menu-2.jpg') }}"
                                                                    alt=""></a>
                                                        </li>
                                                        <li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="shop.html"><img
                                                                    src="{{ asset('assets/img/header/menu/menu-3.jpg') }}"
                                                                    alt=""></a>
                                                        </li>
                                                        <li>
