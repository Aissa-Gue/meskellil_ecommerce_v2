                     ...
                     <div class="col-xl-2 col-lg-2 col-md-4 col-6">
                        <div class="logo">
                           <a href="/">
                              ...
                              <img src="{{ global_info('brand.logo.png') }}" alt="logo" class="img-fluid" width="80px">
                           </a>
                        </div>
                     </div>
                           ...
                           <div class="tp-header-login d-none d-lg-block">
                              @auth
                                 <a href="{{ route('profile.show') }}" class="d-flex align-items-center">
                                    <div class="tp-header-login-icon mx-2">
                                       {{-- <span>
                                       ...
                                       <img src="{{ Auth::user()->avatar ? Auth::user()->avatar : asset('assets/img/users/user-12.png') }}" alt="" width="50" height="50" style="border-radius: 50%; border: 4px solid var(--tp-theme-primary); object-fit: cover;">
                                    </div>
