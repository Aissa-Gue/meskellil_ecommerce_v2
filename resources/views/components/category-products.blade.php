@props(['products', 'category', 'title' => null, 'subtitle' => 'Shop by Category'])

@php
    $displayTitle = $title ?? $category->name ?? 'Category Products';
@endphp
    ...
    <div class="container">
        <div class="row">
            <div class="tp-section-title-wrapper-6 text-center mb-40">
                <span class="tp-section-title-pre-6">{{ $subtitle }}</span>
                <h3 class="tp-section-title-6">{{ $displayTitle }}</h3>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                ...
                                <div class="tp-product-content-3">
                                    ...
                                    <div class="tp-product-price-wrapper-3">
                                        @if($product->has_discount)
                                            <span class="tp-product-price-3 new-price">${{ number_format($product->discounted_price, 2) }}</span>
                                            <span class="tp-product-price-3 old-price">${{ number_format($product->main_price, 2) }}</span>
                                        @else
                                            <span class="tp-product-price-3">${{ number_format($product->main_price, 2) }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
