                        ...
                        <div class="tp-cart-list mb-45 mr-30">
                            <table class="table">
                                ...
                                <tr>
                                    <!-- img -->
                                    <td class="tp-cart-img"><a href="product-details.html"> <img
                                                    src="assets/img/product/cart/product-cart-2.jpg" alt=""></a></td>
                                    <!-- title -->
                                ...
                                <tr>
                                    <!-- img -->
                                    <td class="tp-cart-img"><a href="product-details.html"> <img
                                                    src="assets/img/product/cart/product-cart-3.jpg" alt=""></a></td>
                                    <!-- title -->
                                ...
                                <tr>
                                    <!-- img -->
                                    <td class="tp-cart-img"><a href="product-details.html"> <img
                                                    src="assets/img/product/cart/product-cart-4.jpg" alt=""></a></td>
                                    <!-- title -->
