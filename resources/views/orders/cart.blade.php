                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="tp-cart-empty" id="empty-cart" style="display: none;">
                            <div class="text-center py-5">
                                ...
                                <a href="/" class="tp-btn-2 text-white">Continue Shopping</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4">
                        <div class="tp-cart-checkout-wrapper">
                            ...
                            <div class="tp-cart-checkout-shipping">
                                ...
                                <div class="tp-cart-checkout-shipping-option-wrapper">
                                    <div class="tp-cart-checkout-shipping-option">
                                        ...
                                        <label for="flat_rate">shipping: <span id="cart-shipping">0.00</span></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tp-cart-checkout-proceed">
                                <button onclick="proceedToCheckout()" class="tp-btn tp-btn-2 tp-btn-blue w-100 mb-3" id="checkout-btn">Proceed to
                                    Checkout
                                </button>
                                <button class="tp-btn tp-btn-2 tp-btn-border w-100" id="clear-cart-btn">Clear Cart
                                </button>
                            </div>
                        </div>
                    </div>
