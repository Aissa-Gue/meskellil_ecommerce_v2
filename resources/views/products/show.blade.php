                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                ...
                                <p>{{ Str::limit($product->description, 150) }}
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-10">
                                                    ...
                                                    <div class="tp-product-details-desc-item pb-105">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="tp-product-details-desc-content pt-25 text-center">
                                                                    <h3 class="tp-product-details-desc-title">No Description Available</h3>
                                                                    <p>This product doesn't have a detailed description yet.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
