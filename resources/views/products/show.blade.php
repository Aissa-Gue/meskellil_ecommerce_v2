                                ...
                                <nav>
                                    <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb"
                                        ...
                                        <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="true">
                                            <img
                                                src="{{asset('assets/img/product/details/nav/product-details-nav-1.jpg')}}"
                                                alt="">
                                        </button>
                                        <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">
                                            <img
                                                src="{{asset('assets/img/product/details/nav/product-details-nav-2.jpg')}}"
                                                alt="">
                                        </button>
                                        <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">
                                            <img
                                                src="{{asset('assets/img/product/details/nav/product-details-nav-3.jpg')}}"
                                                alt="">
                                        </button>
                                        <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">
                                            <img
                                                src="{{asset('assets/img/product/details/nav/product-details-nav-4.jpg')}}"
                                                alt="">
                                        </button>
                                        <button class="nav-link" id="nav-5-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">
                                            <img
                                                src="{{asset('assets/img/product/details/nav/product-details-nav-5.jpg')}}"
                                                alt="">
                                        </button>
                                    </div>
                                </nav>
                                <div class="tab-content m-img" id="productDetailsNavContent">
                                    <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                        ...
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img
                                                src="{{asset('assets/img/product/details/main/product-details-main-1.jpg')}}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab"
                                        ...
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img
                                                src="{{asset('assets/img/product/details/main/product-details-main-2.jpg')}}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab"
                                        ...
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img
                                                src="{{asset('assets/img/product/details/main/product-details-main-3.jpg')}}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab"
                                        ...
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img
                                                src="{{asset('assets/img/product/details/main/product-details-main-4.jpg')}}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-5" role="tabpanel" aria-labelledby="nav-5-tab"
                                        ...
                                        <div class="tp-product-details-nav-main-thumb">
                                            <img
                                                src="{{asset('assets/img/product/details/main/product-details-main-5.jpg')}}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                       ...
                                       <span class="tp-cart-minus">
                                        ...
                                        <div class="tp-product-details-add-to-cart mb-15 w-100">
                                            <button class="tp-product-details-add-to-cart-btn w-100">Add To Cart
                                            </button>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="tp-product-details-desc-item  pb-75">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="tp-product-details-desc-thumb">
                                                                    <img
                                                                        src="{{asset('assets/img/product/details/desc/product-details-desc-2.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div
                                                                    ...
                                                                    <h3 class="tp-product-details-desc-banner-title tp-product-details-desc-title">
                                                                        Speed Memory Power = Epic Races</h3>
                                                                    <img
                                                                        src="{{asset('assets/img/product/details/desc/product-details-desc-3.jpg')}}"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tp-product-details-review-list pr-110">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="tp-product-details-review-avater-thumb">
                                                                    <a href="#">
                                                                        <img
                                                                            src="{{asset('assets/img/users/user-3.jpg')}}"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="tp-product-details-review-avater-thumb">
                                                                    <a href="#">
                                                                        <img
                                                                            src="{{asset('assets/img/users/user-2.jpg')}}"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="tp-product-details-review-avater-content">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/img/product/related/product-related-1.jpg')}}"
                                                     alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/img/product/related/product-related-2.jpg')}}"
                                                     alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/img/product/related/product-related-3.jpg')}}"
                                                     alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="{{asset('assets/img/product/related/product-related-4.jpg')}}"
                                                     alt="">
                                            </a>
